...
class GVDirectCmd(genpy.Message):
  _md5sum = "85a111b251f1d10d6f845ad24e6dcd9d"
...
float32[10] steerAngle"""
  __slots__ = ['steerType','throttle','skidSteering','steerAngle']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       steerType,throttle,skidSteering,steerAngle
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_i2f().pack(_x.steerType, _x.throttle, _x.skidSteering))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.steerType, _x.throttle, _x.skidSteering,) = _get_struct_i2f().unpack(str[start:end])
      start = end
      end += 40
