...
def talker():
    ...
    '''
    ctrl_cmd = CtrlCmd()
    ctrl_cmd.longlCmdType = 1  # Throttle control
    ctrl_cmd.accel = 0.5  # Example acceleration value
    ctrl_cmd.brake = 0.0  # No braking
    ctrl_cmd.steering = 0.1  # Example steering angle in radians
    # ctrl_cmd.velocity = 0.0  # Only used if longlCmdType is 2
    # ctrl_cmd.acceleration = 0.0  # Only used if longlCmdType is 3
