...
import com.drtaa.feature_rent.databinding.ItemSearchRentBinding

class SearchListAdapter :
    ListAdapter<Search, SearchListAdapter.SearchViewHolder>(BaseDiffUtil<Search>()) {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): SearchViewHolder {
        val binding = ItemSearchRentBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    inner class SearchViewHolder(private val binding: ItemSearchRentBinding) :
